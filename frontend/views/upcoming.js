...
const Upcoming = (props) => {
  return (
    <div className="upcoming-container">
      <Helmet>
        <title>Upcoming - ServeQuest</title>
        <meta property="og:title" content="Upcoming - ServeQuest" />
      </Helmet>
      <div className="upcoming-calendar">
        <header data-thq="thq-navbar" className="upcoming-navbar-interactive">
          <span className="upcoming-text">ServeQuest</span>
          <div data-thq="thq-navbar-nav" className="upcoming-desktop-menu">
            <nav className="upcoming-links">
              <Link to="/upcoming" className="upcoming-navlink">
                Upcoming
                <span
              ...
              <Link to="/explore" className="upcoming-navlink1">
                Explore
              </Link>
              <Link to="/rewards" className="upcoming-navlink2">
                Rewards
              </Link>
              <Link to="/plaza" className="upcoming-navlink3">
                Plaza
              </Link>
              <Link to="/my-profile" className="upcoming-navlink4">
                My Profile
              </Link>
            </nav>
          </div>
          <div data-thq="thq-burger-menu" className="upcoming-burger-menu">
            <svg viewBox="0 0 1024 1024" className="upcoming-icon">
              <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
            </svg>
          </div>
          <div data-thq="thq-mobile-menu" className="upcoming-mobile-menu">
            <div className="upcoming-nav">
              <div className="upcoming-top">
                ...
                />
                <div data-thq="thq-close-menu" className="upcoming-close-menu">
                  <svg viewBox="0 0 1024 1024" className="upcoming-icon02">
        ...
        <img
          alt="Rectangle55117"
          src="/rectangle55117-mi6e-200h.png"
          className="upcoming-rectangle5"
        />
        <img
          alt="Rectangle55117"
          src="/rectangle55117-mi6e-200h.png"
          className="upcoming-rectangle51"
        />
        <img
          alt="Rectangle55117"
          src="/rectangle55117-mi6e-200h.png"
          className="upcoming-rectangle52"
        />
        <img
